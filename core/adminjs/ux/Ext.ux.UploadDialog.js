...
p.i18n = {
  ...
  reset_btn_tip: 'Очисть очередь.',
  upload_btn_start_text: 'Начать загрузку',
  ...
  progress_waiting_text: 'Подождите...',
  progress_uploading_text: 'Загрузка: {0} из {1}.',
  error_msgbox_title: 'Ошибка',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: '',
  note_queued_to_upload: 'Очередь загрузки.',
  note_processing: 'Идёт загрузка...',
  note_upload_failed: 'Сервер не доступен.',
  note_upload_success: 'OK.',
  note_upload_error: 'Ошибка.',
  note_aborted: 'Отменено.',
