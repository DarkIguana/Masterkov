<?php
        ...
        // Preview options
        $mcImageManagerConfig['preview.wwwroot'] = getenv('DOCUMENT_ROOT').'/'; // absolute or relative from this script path, try to leave blank system figures it out.
        ...
        $mcImageManagerConfig['filesystem.path'] = getenv('DOCUMENT_ROOT').'/upload-files/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = getenv('DOCUMENT_ROOT').'/upload-files/';  // absolute or relative from this script path, required.
