<?php
        ...
        // Preview options
        $mcFileManagerConfig['preview.wwwroot'] = getenv('DOCUMENT_ROOT').'/'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
        ...
        $mcFileManagerConfig['filesystem.path'] = getenv('DOCUMENT_ROOT').'/upload-files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = getenv('DOCUMENT_ROOT').'/upload-files/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,xls,xlsx,doc,docx,jpeg,png,rarm,pdf";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,xls,xlsx,doc,docx,jpeg,png,rarm,pdf";
