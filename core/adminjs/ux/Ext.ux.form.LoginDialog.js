            ...
            listeners: {
                render: function() {
                    this.capsWarningTooltip = new Ext.ToolTip({
                        ...
                        anchor: 'top',
                        width: 305,
                        html: '<div class="ux-auth-warning">Включен Caps Lock</div><br />' +
                            '<div>При включённом Caps Lock вы можете вести не правильный пароль.</div><br />' 
...
Ext.extend (Ext.ux.form.LoginDialog, Ext.util.Observable, {
    ...
    setMessage : function (msg) {
    	Ext.DomHelper.overwrite( this._headPanel, {
    		html:msg
    	});
