				...
				<fieldset>
					<table>
						...
						<tr>
							...
							<td><textarea rows="" cols="" name="Comments" placeholder="Комментарий"></textarea><input type="submit" onclick="send_rem(); return false;" class="formSubmit1" value="Отправить заявку"></td>
						</tr>
					</table>
				</fieldset>
			</form>
