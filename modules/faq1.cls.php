...
class faq extends glb {
	...
	function __construct() {
		...
		$d = '';
		$_SESSION ['Titles'] ['title'] .= " / Вопрос-ответ";
		$_SESSION ['Road'] .= " Вопрос-ответ";
		...
		while ( $row = mysql_fetch_array ( $sql ) ) {
			$d .= '<p class="faq_name">' . $row ['name'] . ' ' . $this->date_rus ( $row ['date'] ) . '</p>
        <p><em><strong>Вопрос:</strong> ' . $row ['text'] . '</em></p>
        <p style="padding-left:10px;"><em><strong>Ответ:</strong> ' . $row ['answer'] . '</em></p><p>&nbsp;</p>';
	...
	function form() {
		...
		$d .= ' <p align="center">&nbsp;</p>		
		<h3 style="color: #000000;font: bold 14px Arial; margin: 0;padding-bottom: 20px;">Задать свой вопрос</h3>
		
		<a name="addQuestion"></a>
      
     ' . $error . '
      <center>
      <table border="0" cellspacing="0" cellpadding="0" align="center" id="faqForm" >
      
        <tr>
          <td><form action="#addQuestion" method="post">
     
      &nbsp;&nbsp; <strong>Ваше имя:</strong><br />
      <input type="text" name="name" value="' . $name . '" class="inp1" /> <br /><br/>
       &nbsp;&nbsp;<strong>E-mail (не отображается на сайте):</strong><br />
      <input type="text" name="email" value="' . $email . '" class="inp1" /><br/><br/>
     
      <strong>Ваш Вопрос:</strong><br />
      <textarea  rows="4" name="answer" class="inp2">' . $answer . '</textarea><br /><br/>
<strong>Введите слово с картинки</strong><br />
<table><tr><td width="220"  style="vertical-align:middle"><input type="text" name="code" class="inp1" /></td><td style="vertical-align:top"><img src="getcaptcha.php"  height="35"/></td></tr></table>
      
    
<br/>
      <div align="center"><input type="submit" class="button" name="submitReview" value="Задать вопрос" /></div></form>
      </form></td>
        </tr>
      </table>
      </center>
