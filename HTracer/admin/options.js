	...
	$(function() {
		if($('#test_query').val().trim())
			CheckQueryFilters();
				...
				+ CreateOptString("htracer_numeric_filter")
				+ CreateOptString("htracer_not_ru_filter");
		$('#test_query,#htracer_trace_sex_filter,#htracer_trace_free_filter,#htracer_trace_download_filter,#htracer_mats_filter,#htracer_symb_white_list,#htracer_numeric_filter,#htracer_not_ru_filter').change(function(){CheckQueryFilters()});
		$('#test_query').keypress(function(){CheckQueryFilters()});
