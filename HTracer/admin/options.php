		...
		<div class="tabs">
			...
			<div id="tabs-main">
				...
				<table>
					...
					<tr>
							<th><span class='hint' hcontent='<?php echo ht_trans('Пароль хешируеться и записываеться в cookies браузера')?>. <?php echo ht_trans('Поэтому, вводить его нужно крайне редко')?>. <br /><br />'>
						...
						<tr>
							...
							<td colspan="2">
								<div id="usp_options_dialog" class='plugin_options' title=<?php echo ht_trans('Настройки модуля USP')?>" style='display:none'>
									...
									<small><?php echo ht_trans('Эти данные используются только в подсказках при вводе заголовка. Так что заполнять их необязательно.')?></small> 
								</div>
							</td>
						</tr>
					<!--/USP-->
			...
			</td><td style="padding-left: 15px; border-left: 1px solid rgb(206, 239, 214);" valign='top'>
