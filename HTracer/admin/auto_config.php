<?php 
		...
		if(!isset($GLOBALS['htracer_trace_grooping']))
			$GLOBALS['htracer_trace_grooping']=5;
		...
		if(!isset($GLOBALS['htracer_trace_free_filter']))
			$GLOBALS['htracer_trace_free_filter']=false;
		...
		if(!isset($GLOBALS['htracer_admin_pass']))
			$GLOBALS['htracer_admin_pass']="681556cfef617de6ee1e2c2c035f40cd";
		...
		if(!isset($GLOBALS['htracer_cloud_links']))
			$GLOBALS['htracer_cloud_links']=5;
		if(!isset($GLOBALS['htracer_cloud_randomize']))
			$GLOBALS['htracer_cloud_randomize']=10;
		...
		if(!isset($GLOBALS['htracer_cloud_style']))
			$GLOBALS['htracer_cloud_style']="ul_list";
